...
export const H1 = ({ children, className }: HeadingProps) => (
  <h1 className={cn('h1 text-textPrimary dark:text-background', className)}>
    {children}
  </h1>
);
...
export const H2 = ({ children, className }: HeadingProps) => (
  <h2 className={cn('h2 text-textPrimary dark:text-background', className)}>
    {children}
  </h2>
);
...
export const H3 = ({ children, className }: HeadingProps) => (
  <h3 className={cn('h3 text-textPrimary dark:text-background', className)}>
    {children}
  </h3>
);
...
export const H4 = ({ children, className }: HeadingProps) => (
  <h4 className={cn('h4 text-textPrimary dark:text-background', className)}>
    {children}
  </h4>
);
...
export const Body = ({ children, className }: TextProps) => (
  <p className={cn('body text-textPrimary dark:text-background', className)}>
    {children}
  </p>
);
...
export const Small = ({ children, className }: TextProps) => (
  <p className={cn('small text-textPrimary dark:text-textSecondary', className)}>
    {children}
  </p>
);
...
export const Tiny = ({ children, className }: TextProps) => (
  <p className={cn('tiny text-textSecondary dark:text-textSecondary', className)}>
    {children}
  </p>
);
...
export const TextSecondary = ({ children, className }: TextProps) => (
  <p className={cn('body text-textSecondary', className)}>
    {children}
  </p>
);
